package com.lgd.wifi_test.wifi;
...
public class WifiManagerr {

    private static final String TAG = "WifiManagerr";
    ...
    public static List<ScanResult> getWifiScanResult(Context context) {
        ...
        return ((android.net.wifi.WifiManager) context.getSystemService(Context.WIFI_SERVICE)).getScanResults();
    }
    ...
    public static WifiInfo getConnectedWifiInfo(Context context) {
        return ((android.net.wifi.WifiManager) context.getSystemService(Context.WIFI_SERVICE)).getConnectionInfo();
    }

    public static List getConfigurations(Context context) {
        return ((android.net.wifi.WifiManager) context.getSystemService(Context.WIFI_SERVICE)).getConfiguredNetworks();
    }
